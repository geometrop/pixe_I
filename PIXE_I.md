...
<body>
  ...
  <button onclick="playRandomVideos()">Play Random Videos</button>
  ...
  <script>
    ...
    var videos = [
      { id: 'eKThFMTDwGQ', start: getRandomInt(0, 300) },
      { id: '0Egw3hIh1FM', start: getRandomInt(0, 300) },
      { id: '3IUxxrVlWK0', start: getRandomInt(0, 300) },
      { id: '5yHBWJG0sro', start: getRandomInt(0, 300) },
